    ...
    if reqType == 0:        
        if sqlType == 0:            
            sql = "SELECT name FROM boardgame WHERE \
                   ...
                   ORDER BY prevail DESC" % (attrList[0], attrList[0])
            ...
            sql = "SELECT name FROM boardgame WHERE \
                   ...
                   (attrList[0],attrList[0],attrList[0],attrList[0],attrList[0])
        ...
        if sqlType == 0:            
            ...
            sql = "SELECT label1,label2,label3,label4,label5 \
                   FROM boardgame WHERE name = '%s'" % (attrList[0])
