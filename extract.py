...
# 示例
桌游名表 = "(德州扑克|德克萨斯扑克|斗地主|干瞪眼|富饶之城|达芬奇密码|德国心脏病|抵抗组织|大富翁|地产大亨|只言片语|谁知我心|狼人杀|三国杀|uno|UNO|Uno|乌诺|乌诺纸牌|角斗士棋|格格不入|俄罗斯方块棋|宿命|星杯|星杯传说|阿瓦隆|冷战热斗|卡坦岛|风声|波多黎各|矮人矿工|矮人矿坑|卡卡颂|卡卡城|历史巨轮|电力公司|发电厂|怒海求生|救生艇|山屋惊魂|小黑屋|冰与火之歌|权力的游戏|马尼拉|僵尸广场)"
...
def extract(sentence):
    ...
    popular = re.compile(流行).search(sentence)
